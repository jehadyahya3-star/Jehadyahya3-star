...
import { Database, Download, Upload, RefreshCw, X, AlertOctagon } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-5 shadow-2xl relative">
        ...
        <div className="flex items-center justify-between border-b pb-3">
          <h3 className="font-extrabold text-slate-900 text-base flex items-center gap-2">
            ...
            <span>النسخ الاحتياطي وإدارة بيانات النظام</span>
          </h3>
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between">
            <div>
              <h4 className="font-bold text-xs text-slate-900">تصدير نسخة احتياطية (JSON)</h4>
              <p className="text-[10px] text-slate-500">تحميل كافة السجلات والم المعدات والديزل في ملف آمن</p>
            </div>
            <button
